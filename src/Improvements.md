...
- There should be a line between those node, like edges in the NodeGraph. Also the direction of flows are wrong. Server should send and clients should recive.
